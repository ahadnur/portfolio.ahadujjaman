...
const About = () => {
  return (
    <div id="about" className="min-h-[70vh]">
        <h2 className="font-mono text-main relative after:absolute after:top-1/2 after:-translate-y-1/2 after:ml-5 after:h-[1px] after:w-40 after:bg-white/30 after:rounded-full text-md md:text-xl">01. <span className="text-white/90 text-2xl md:text-4xl font-bold">Who Am I?</span></h2>
